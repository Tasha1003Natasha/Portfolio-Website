        ...
        <div className="lg:max-w-[1200px]  mx-auto bg-[#adbbc5] text-[#000080]  dark:bg-[#0d1c2c] dark:text-[#8892b0]">
          <div className="pt-2 lg:pt-0 flex flex-col md:flex-row md:items-center items-center">
            <div className="flex flex-col justify-center items-center">
              <p className="text-gray-50  lg:text-2xl">Hi, my nickname is</p>

              <h2 className="text-lg sm:text-xl lg:text-4xl  p-2 text-[#fffd88] dark:text-yellow-300 ">
                Tasha Natasha
              </h2>
              <h2 className="text-lg sm:text-xl lg:text-3xl  mb-2 text-gray-50">
                I'm a Full Stack Developer.
              </h2>
              <p className="mx-4 lg:mb-4  text-center lg:text-2xl text-gray-50 mb:mb-4]">
                I am passionate about creating websites that improve the lives
                of those around me.
              </p>
              <div>
                <button className="text-[#0a192f] bg-[#ccd6f6]  lg:text-xl group border-2 px-3 py-2 md:px-4  my-2 flex items-center hover:bg-[#fffd88] hover:border-bg-[#fffd88] dark:hover:bg-yellow-300 dark:hover:border-yellow-300">
